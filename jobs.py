"""
PCB Mapping:
- job_id -> Process ID (PCB field)
- priority -> Scheduling Information (PCB field)

The fields arrival_time, burst_time, and zone are
scheduling-simulation metadata and are not PCB fields.
"""
